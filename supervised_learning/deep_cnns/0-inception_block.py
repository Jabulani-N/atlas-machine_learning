...
def inception_block(A_prev, filters):
    ...
    filters = a tuple or list
        containing [F1, F3R, F3,F5R, F5, FPP]:
            ...
            F3R = number of filters in 1x1 convolution
                before the 3x3 convolution
            F3 = number of filters in 3x3 convolution
            F5R = number of filters in 1x1 convolution
                before the 5x5 convolution
            F5 = number of filters in 5x5 convolution
            FPP = number of filters in 1x1 convolution
                after the max pooling
    All convolutions inside inception block
        use ReLu activation
